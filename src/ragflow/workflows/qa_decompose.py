...
class QaDecompositionWorkflow(WebCopyWorkflow):
    ...
    def answer(self, qa: str, chat_history: str) -> Dict:
        ...
        while len(chosen_atom_infos) < 1:
            ...
            decompose, thinking, proposals = self._propose_question_decomposition(qa, chosen_atom_infos)
        ...
        output = self._answer_original_question(qa, chosen_atom_infos)
